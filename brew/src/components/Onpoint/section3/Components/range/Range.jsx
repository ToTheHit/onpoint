...
const Range = (props) => {
  ...
  const dragItem = useCallback((e) => {
    ...
    if (active) {
      ...
      if (current.currentX > borderData.width - dragItemData.width / 2) current.currentX = borderData.width - dragItemData.width / 2;
  ...
  return (
    ...
    >
      <g ref={dragContainerRef}>
        <rect x="195" y="682" width="640" height="12" fill="rgba(209, 234, 255, 0.5)"
              ref={borderRef} />
        <rect
          x="195" y="682"
          width="0" height="12"
